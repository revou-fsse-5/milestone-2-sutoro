...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (values: User) => {
    const userPayload = {
      ...
      avatar: "https://api.lorem.space/image/face?w=150&h=150", // Example avatar URL
    };

    try {
      // Sending a POST request to the Platzi Fake Store API's registration endpoint
      await axios.post("https://api.escuelajs.co/api/v1/users/", userPayload);
